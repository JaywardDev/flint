...
export function BottomNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl items-end justify-around px-6 pb-2 pt-1.5">
...
function SideItem({
  ...
  return (
    <Link
      ...
      className={`flex min-h-12 min-w-16 flex-col items-center justify-center gap-1 rounded-lg py-1 text-xs font-medium transition ${
